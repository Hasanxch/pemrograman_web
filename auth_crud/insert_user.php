    ...
    <head>
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $query = mysqli_query($conn, "INSERT INTO user(user_id, username, password, privilage, email, born, sex, phone, address, bio, website) "
                        . "VALUES ('', '$username', '$password', '$privilage','$email', '$born', '$sex', '$phone', '$address', '$bio', '$website')");
                if ($query) {
